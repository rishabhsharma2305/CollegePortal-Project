...
public class adminRemoveStudent extends javax.swing.JFrame {
    ...
    /**
     * Creates new form adminRemoveStudent
     */
    Connection conn;
    ResultSet rs;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            String sql="delete from student_detail where roll=?";
            pst= conn.prepareStatement(sql);
            pst.setInt(1,roll);
            pst.executeUpdate();
            JOptionPane.showMessageDialog(null,"student "+roll+" deleted successfully");
        }
        catch(Exception e){
