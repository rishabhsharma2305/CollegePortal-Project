...
public class adminUpdateFaculty extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String sql="update faculty_detail set name=?, contact=?, designation=?, class=? where id=?";
            ...
            pst.setInt(5, id); 
            pst.executeUpdate();
            JOptionPane.showMessageDialog(null,"faculty "+id+" updated successfully");
        }
        catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(adminUpdateFaculty.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new adminUpdateFaculty().setVisible(true);
            }
        });
    }
